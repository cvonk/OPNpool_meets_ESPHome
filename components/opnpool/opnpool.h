...
class OpnPool : public Component {
  ...
  public:
    ...
    // ========== Accessors ==========
    [[nodiscard]] ipc_t * get_ipc() { return ipc_; }                           ///< Returns IPC structure pointer.
    [[nodiscard]] PoolState * get_opnpool_state() { return poolState_; }       ///< Returns pool state pointer.
    [[nodiscard]] OpnPoolSwitch * get_switch(uint8_t id) { return this->switches_[id]; }  ///< Returns switch by ID.
