...
char const *
network_ctrl_date_str(uint8_t const year, uint8_t const month, uint8_t const day)
{
...
char const *
network_ctrl_time_str(uint8_t const hours, uint8_t const minutes)
{
...
network_pump_program_str(uint16_t const address)
{
    ...
    switch (prg_addr) {
        case network_pump_program_addr_t::UNKNOWN_2BF0:  return "?";
        case network_pump_program_addr_t::UNKNOWN_02BF:  return "?";
